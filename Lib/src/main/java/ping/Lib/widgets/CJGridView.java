 ...
 */
public class CJGridView extends GridView {
    ...
    public CJGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CJGridView(Context context, AttributeSet attrs, int defStyle) {
